    ...
    <section class="container">
        <div class="container-page">				
            <div class="col-md-12">
                ...
                <div class="row">
                     <div class="form-group col-lg-12 text-left">
                        <a href="index.php/receiveDocumentOnline/receiveDocumentOnline/receiveDocumentOnlineForDepartment" class="btn btn-warning"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true">&nbsp;ลงรับเอกสารจากตะกร้า Online</span></a>
                ...
                <div class="row">
                    ...
                    <form action="index.php/recieptBook/recieptBook/search_word_dep" method="post" id = "search1">
                        ...
                        <div   class="form-group col-lg-7">
                            ...
                            <a href = "index.php/recieptBook/recieptBook/recieptBookForDepartment" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open" aria-hidden="true">&nbsp;แสดงทั้งหมด</a>
                ...
                <form action="index.php/recieptBook/recieptBook/search_date_dep" method="post" id = "search2">
                <div class="row">
                    <div class="form-group col-lg-2 text-right">
                    ...
                    <div class="tab-pane fade in active" id="tab1default">
                        <table id="" class="display mytd" cellspacing="0" width="100%">
                            <thead>
                                ...
                                <th style ='width:120px!important;text-align:center!important;'>จาก</th>
                                ...
                                <th style ='width:120px!important;text-align:center!important;'>จัดการ</th>
                            </thead>
                            <tbody>
                        <?php 
                        ...
                        foreach($recieve_doc as $row_online){
                            ...
                            <tr>
                                <td style ='text-align:center!important;'>
                                    ...
                                    <?php 
                                        if($row_online['receive_type'] == "online"){
                                            ...
                                            if($row_online['status_reading'] == 'yes')
                                            {
                                        ...
                                        $col1 = $row_online['registration_create_number_id'];
                                        
                                        $sql = "select * from registration_create_number_file_upload where registration_create_number_id =  $col1 ";
                                        $result = $this->db->query($sql);
                                        $temp2 = $result->result_array();
                                        
                                        $col2 = $row_online['registration_receive_document_id'];
                                        
                                        $sql = "select * from registration_receive_document_file_upload where registration_receive_document_id =  $col2 ";
                                        $result2 = $this->db->query($sql);
                                        $temp3 = $result2->result_array();
                                ...
                                <td style ='text-align:center!important;'><?php echo $row_online['dep_receive_date']; ?></td>
                                <td style ='text-align:center!important;'><?php echo $row_online['dep_receive_time']; ?></td>
                                <td style ='text-align:center!important;'>
                                    <?php 
                                        if($row_online['receive_type'] == "online"){
                                ...
                                <td style ='text-align:center!important;'>
                                    <p>
                                    <a  href = "index.php/recieptBook/recieptBook/show_detail/<?php echo $row_online['registration_receive_document_id'];?>/<?php echo $row_online['registration_create_number_id'];?>" class =  "btn btn-success btn-xs">
