...
<div style = "margin-left:15px; margin-right:15px">
    <div style = "width :100% ; background-color: #3A01DF; padding-left :15px ;color:#FFFFFF"><h2><img src = "assets/img/Custom-Icon-Design-Pretty-Office-9-Email-send.ico" width = "40px">&nbsp;&nbsp;<b>พิมพ์รายงานสมุดทะเบียนรับ</b></h2></div>
    ...
    <div class="row">
        <div class="panel-body form-horizontal payment-form">
            <form   id="submitSearch" action="index.php/report/book_receive/confirmBookReceive" method="post">
                ...
                <div class="form-group">
                    <label  class="col-sm-12 text-center "><h2><font color="#0000FF">สมุดทะเบียนรับ</font></h2></label>
                </div>
                <hr width="100%">
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-12 text-right">
                        <a class="btn btn-success AAA"><span class="glyphicon glyphicon-search" aria-hidden="true">&nbsp;ค้นหาสมุดทะเบียนรับ</span></a>
    ...
    $(document).ready(function() {
        ...
        $('#department_id').autocomplete({
            source: function(request, response) {
                $.ajax({
                    url: 'index.php/report/book_receive/getDocumentNo',
                    dataType: "json",
                    data: {
