						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						     <div style = "margin :20px">
						      ...
						      <form class="form-horizontal" onsubmit="return false" method="post" id = "modal_createnumber2">
						      <div class="modal-body">
					            ...
					            <div class="form-group">
					              ...
					              <div class="col-md-9">
					                <input id="instutition_number2" name="instutition_number2" type="text" placeholder="เลขทะเบียน " class="form-control">
					              </div>
					            </div>
					            <div class="form-group">
					              <label class="col-md-3 control-label" for="email">เลขส่งทะเบียนหน่วยงาน </label>
					              <div class="col-md-9">
					                <input readonly id="institution_send_number2" name="institution_send_number2" type="text" placeholder="เลขส่งทะเบียนหน่วยงาน" class="form-control">
					              </div>
					            </div>
					            <div class="form-group">
					              <label class="col-md-3 control-label" for="email">รายละเอียด</label>
					              <div class="col-md-9">
					                <textarea name = "details_of_number2" id = "details_of_number2" class="form-control" placeholder="รายละเอียด" rows="3"></textarea>
					              </div>
					            </div>
					            <br><hr><br>
					            <div class="form-group">
					              ...
					              <div class="col-md-9">
					                <input readonly id="federal_registe2" name="federal_registe2" type="text"  class="form-control">
					              </div>
					                <input type = "text" id = "hide2" name = "hide2"/>
					                 <input type = "text" id = "hide_id2" name = "hide_id2"/>
					            </div>
					              <div class="form-group">
					             ...
					             <div class="form-group">
					              ...
					              <div class="col-md-9">
					                <input id="number_recieve2" name="number_recieve2" type="text" placeholder="เลขทะเบียนรับ " class="form-control">
					              </div>
					            </div>
					             <div class="form-group">
					              <label class="col-md-3 control-label" for="email">เลขทะเบียนส่งภายใน</label>
					              <div class="col-md-9">
					                <input id="number_internal2" name="number_internal2" type="text" placeholder="เลขทะเบียนส่งภายใน " class="form-control">
					              </div>
					            </div>
					             <div class="form-group">
					              <label class="col-md-3 control-label" for="email">เลขทะเบียนส่งภายนอก</label>
					              <div class="col-md-9">
					                <input id="number_external2" name="number_external2" type="text" placeholder="เลขทะเบียนส่งภายนอก" class="form-control">
					              </div>
					            </div>
					              <div class="form-group">
					             ...
					             <div class="form-group">
					              ...
					              <div class="col-md-9">
					                 <div class="checkbox">
								  <label>
								    <input type="checkbox" value="1" name  = "setup_instutition_number2" id = "setup_instutition_number1" />
								...
								<div class="checkbox ">
								  <label>
								    ...
								    <input id="setup_instutition_number2" name="setup_instutition_number22" type="text" placeholder="" class="form-control">
								  </label>
								</div>
								<div class="checkbox ">
								  <label>
								    ...
								    <input id="setup_institution_number3" name="setup_institution_number32" type="text" placeholder="" class="form-control">
								  </label>
								</div>
					              </div>
					            </div>
					           
					            <input id="hide3" name="hide3" type="text" />
						      </div>
						    </div>
						    <div class="modal-footer">
						        ...
						        <input type = "submit" id = "save2" class="btn btn-primary" value="บันทึก"/>
						      </div>
						    </div>
						    </div>
						  </div>
