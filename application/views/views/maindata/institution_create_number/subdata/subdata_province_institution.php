		  ...
		  <tbody>
		  	...
		  	?>
		  		<tr>
		  			 ...
		  			 <td>
		  			 	<a href = "index.php/maindata/institution_create_number/show_form_update/1/<?php echo $row['id']; ?>/<?php echo base64_encode($row['institution_province_name']); ?>"  id = "update1" class = "btn btn-warning updateins1">จัดการเลขทะเบียน</a>
		  			 </td>
		  		</tr>	
		  	<?php }?>
        </tbody>
