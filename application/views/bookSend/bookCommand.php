        ...
        <div class="container-page">				
            <div class="col-md-12">
                ...
                <div class="row">
                    ...
                    <form action="index.php/bookCommand/bookCommand/search_word" method="post" id = "search1">
                        ...
                        <div   class="form-group col-lg-7">
                            ...
                            <a href = "index.php/bookCommand/bookCommand" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open" aria-hidden="true">&nbsp;แสดงทั้งหมด</a>
                 ...
                 <form action="index.php/bookCommand/bookCommand/search_date" method="post" id = "search2">
                <div class="row">
                    <div class="form-group col-lg-2 text-right">
