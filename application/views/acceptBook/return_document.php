    ...
    <div class="row">
      ...
      <div class="col-md-8">
        <div class="well well-sm">
          <form class="form-horizontal" action="index.php/acceptBook/acceptBook/accept_return_document" method="post" id = "return_accept">
            <!-- Message body -->
            ...
            <input type="hidden" name = "id_accept" id = "id_accept" value='<?php echo $id_accept;?>'/>
            <input type="hidden" name = "id_create" id = "id_create" value='<?php echo $id_create;?>'/>
            <!-- Form actions -->
            <div class="form-group">
