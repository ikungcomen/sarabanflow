...
<div style = "margin-left:15px; margin-right:15px">
    <div style = "width :100% ; background-color: #DF7401; padding-left :15px ;color:#FFFFFF"><h2><img src = "assets/img/Custom-Icon-Design-Pretty-Office-9-Email-send.ico" width = "40px">&nbsp;&nbsp;<b>ค้นหาสมุดทะเบียนส่ง</b></h2>
    </div>
...
<div class="container">
    <div class="row">
        <div class="panel-body form-horizontal payment-form">
            <form   id="submitSearch" action="index.php/searchreport/searchreport/search_send_report" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <input type="text"    class="form-control selectValue" id="form_send" name="form_send" value=""    placeholder="จาก/ผู้ส่ง"><?php //echo get_name_instutition($this->level_institution_id, $this->level_institution); ?>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-sm-12 text-right">
                        <a class="btn btn-success btnSearch"><span class="glyphicon glyphicon-search" aria-hidden="true">&nbsp;ค้นหาสมุดทะเบียนส่ง</span></a>
